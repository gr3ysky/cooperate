...
<title><spring:message code="title.profile.update"/></title>
<body>
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
<div class="panel panel-default">
    <div class="panel-heading">
        <spring:message code="title.profile.update"/>
    </div>
    <div class="panel-body">
        <div class="row">
            <form:form modelAttribute="profile" action="/profile/updateProfile" method="post" class="form-horizontal"
