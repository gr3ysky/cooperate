...
<title><spring:message code="title.producerImages.update"/></title>
<body>
<content tag="page_header">
    <div class="row">
        <div class="col-xs-12 margin-bottom-10">
            <div class="btn-group pull-right" role="group">
                <a class="btn btn-primary" href="/admin/producer-images/${producerImage.producerId}"><spring:message
                        code="title.producerimages.index"/></a>
...
<div class="row">
    <form:form modelAttribute="producerImage" action="/admin/producer-images/updateProducerImage" method="post"
    ...
    <c:if test="${not empty productImage.imageUrl}">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <img style="width:100%" alt="${producerImage.altText}" src="${producerImage.imageUrl}">
            </div>
        </div>
    </c:if>
</div>
