...
<title><spring:message code="title.producerImage.create"/></title>
<body>
...
<div class="row">
    <form:form modelAttribute="producerImage" action="/admin/producer-images/createProducerImage" method="post"
