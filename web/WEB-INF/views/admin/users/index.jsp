...
<content tag="local_script">
    ...
    <script>
        $(function () {
            ...
            KS.Grid.Render("#test-grid table", "/admin/users/list", {
                columns: [
                    {data: "fullName"},
                    {data: "email"},
                    {data: "roleName"},
                ...
                customButtons: [
                    {button: new KS.Grid.Button(KS.Grid.ButtonTypes.Create, null, "/admin/users/create", null, "<spring:message code="label.new"/>", "User.openCreate(this);")},
                    {button: new KS.Grid.Button(KS.Grid.ButtonTypes.Enable, null, "/admin/users/enable", ["userId", "isActive"], "<spring:message code="label.setEnabled"/>", "User.openEnable(this);")},
                    {button: new KS.Grid.Button(KS.Grid.ButtonTypes.Update, null, "/admin/users/update", ["userId"], "<spring:message code="label.update"/>", "User.openUpdate(this);")},
                ]
            });
