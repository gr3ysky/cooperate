...
<title><spring:message code="title.product.update"/></title>
<body>
...
<div class="row">
    <form:form modelAttribute="product" action="/admin/products/updateProduct" method="post" class="form-horizontal">
