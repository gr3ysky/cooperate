...
<title><spring:message code="title.producer.update"/></title>
<body>
...
<div class="row">
    <form:form modelAttribute="producer" action="/admin/producers/updateProducer" method="post" class="form-horizontal">
        ...
        <div class="form-group col-md-6 col-xs-12">
            ...
            <div class="col-md-8 col-xs-12">
                <form:input cssClass="form-control" path="latitude" type="number"/>
        ...
        <div class="form-group col-md-6 col-xs-12">
            ...
            <div class="col-md-8 col-xs-12">
                <form:input cssClass="form-control" path="longitude" type="number"/>
