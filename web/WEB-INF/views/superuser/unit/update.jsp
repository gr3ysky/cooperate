...
<title><spring:message code="title.unit.update"/></title>
<body>
<content tag="page_header">
    <div class="row">
        <div class="col-xs-12 margin-bottom-10">
            <div class="btn-group pull-right" role="group">
                <a class="btn btn-primary" href="/su/unit"> <spring:message
                        code="title.unit.index"/></a>
...
<div class="row">
    <form:form modelAttribute="unit" action="/su/unit/update" method="post"
