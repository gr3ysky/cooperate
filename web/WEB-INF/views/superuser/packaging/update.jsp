...
<title><spring:message code="title.packaging.update"/></title>
<body>
<content tag="page_header">
    <div class="row">
        <div class="col-xs-12 margin-bottom-10">
            <div class="btn-group pull-right" role="group">
                <a class="btn btn-primary" href="/su/packaging"> <spring:message
                        code="title.packaging.index"/></a>
...
<div class="row">
    <form:form modelAttribute="packaging" action="/su/packaging/update" method="post"
               class="form-horizontal">

        <form:hidden path="packagingId"/>
