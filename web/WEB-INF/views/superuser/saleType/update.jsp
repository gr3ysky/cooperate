...
<title><spring:message code="title.saleType.update"/></title>
<body>
<content tag="page_header">
    <div class="row">
        <div class="col-xs-12 margin-bottom-10">
            <div class="btn-group pull-right" role="group">
                <a class="btn btn-primary" href="/su/sale-type"> <spring:message
                        code="title.saleType.index"/></a>
...
<div class="row">
    <form:form modelAttribute="saleType" action="/su/sale-type/update" method="post"
               class="form-horizontal">

        <form:hidden path="saleTypeId"/>
