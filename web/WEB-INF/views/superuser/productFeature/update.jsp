...
<title><spring:message code="title.productFeature.update"/></title>
<body>
...
<div class="row">
    <form:form modelAttribute="productFeature" action="/su/product-feature/update" method="post"
               class="form-horizontal" enctype="multipart/form-data">
        <form:hidden path="productFeatureId"/>
